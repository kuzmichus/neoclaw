  ...
  return (
    ...
    >
      ...
      {visible &&
        ...
        createPortal(
          <div
            className={`bg-popover text-popover-foreground fixed z-50 w-[220px] rounded-xl border p-4 shadow-lg transition-all duration-150 ${
              animated
